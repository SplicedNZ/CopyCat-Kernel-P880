...
static struct dvfs core_dvfs_table[] = {
...
#ifdef CONFIG_MACH_X3
	CORE_DVFS("sbus",   3, 1, KHZ,        1,      1,      1,      1,      1,       1,  216000,  216000,  216000),
#else
...
#ifdef CONFIG_MACH_X3
	CORE_DVFS("vi",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  400000,  300000,  300000),
#else
	CORE_DVFS("vi",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  470000,  470000,  470000),
#endif

	CORE_DVFS("vde",    0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),

	CORE_DVFS("vde",    1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("mpe",    1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("2d",     1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("epp",    1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("3d",     1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  564000),
	CORE_DVFS("3d2",    1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  564000),
	CORE_DVFS("se",     1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  564000,  564000),

	CORE_DVFS("vde",    2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("mpe",    2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("2d",     2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("epp",    2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("3d",     2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("3d2",    2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("se",     2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),

	CORE_DVFS("vde",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  520000,  520000,  564000),
	CORE_DVFS("mpe",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  520000,  520000,  564000),
	CORE_DVFS("2d",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  520000,  520000,  564000),
	CORE_DVFS("epp",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  520000,  520000,  564000),
	CORE_DVFS("3d",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  520000,  520000,  564000),
	CORE_DVFS("3d2",    3, 1, KHZ,        1,      1,      1,      1,      1,       1,  520000,  520000,  564000),
#ifdef CONFIG_MACH_X3
	CORE_DVFS("se",     3, 1, KHZ,        1,      1,      1,      1,      1,       1,  564000,  520000,  564000),
#else
	...
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("cbus",   1, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
	CORE_DVFS("cbus",   2, 1, KHZ,   200000, 267000, 304000, 416000, 484000,  520000,  520000,  520000,  564000),
#ifdef CONFIG_MACH_X3
	CORE_DVFS("cbus",   3, 1, KHZ,        1, 564000,  564000, 564000, 564000,  564000,  564000,  564000,  564000),
#else
...
#ifdef CONFIG_MACH_X3
	CORE_DVFS("nor",    0, 1, KHZ,       1, 130000, 130000, 133000, 133000,  133000,   133000,  133000),
//                     
	CORE_DVFS("nor",    1, 1, KHZ,   102000, 130000, 130000, 133000, 133000,  133000,   133000,  133000),
	CORE_DVFS("nor",    2, 1, KHZ,   102000, 130000, 130000, 133000, 133000,  133000,   133000,  133000),
	CORE_DVFS("nor",    3, 1, KHZ,       1,      1,      1,      1,      1,  108000,   108000,  108000),
#else
...
#ifdef CONFIG_MACH_X3
	CORE_DVFS("sbc1",  -1, 1, KHZ,    36000, 60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc2",  -1, 1, KHZ,    36000, 60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc3",  -1, 1, KHZ,    36000, 60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc4",  -1, 1, KHZ,    36000, 60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc5",  -1, 1, KHZ,    36000, 60000,  60000,  60000, 100000,  100000,   100000,  100000),
	CORE_DVFS("sbc6",  -1, 1, KHZ,    36000, 60000,  60000,  60000, 100000,  100000,   100000,  100000),
#else
...
#ifdef CONFIG_MACH_X3
	CORE_DVFS("dsia",  -1, 1, KHZ,    432500, 275000, 275000, 275000, 275000, 275000,  275000,   275000,  275000),
	CORE_DVFS("dsib",  -1, 1, KHZ,    432500, 275000, 275000, 275000, 275000, 275000,  275000,   275000,  275000),
#else
